    ...
    return (
        <>
            <ScrollArea className="w-full rounded-md border">
                <MyImageGallery
                    imagePath="/assets/images/banner_positions/"
                            ...
                            <TableRow key={item.id}>
                                ...
                                <TableCell>
                                    <span className="flex h-full items-center justify-start">
                                        ...
                                        {hasPermission('banner delete') && <DeleteButton deletePath="/admin/banner_positions/" id={item.id} />}
                                ...
                                <TableCell>
                                    {item.image ? (
                                        ...
                                        >
                                            <img
                                                src={`/assets/images/banner_positions/thumb/` + item.image}
                                                width={100}
                                                height={100}
                                                alt=""
                                ...
                                <TableCell>
                                    {item.banner ? (
                                        ...
                                        >
                                            <img
                                                src={`/assets/images/banner_positions/thumb/` + item.banner}
                                                width={100}
                                                height={100}
                                                alt=""
                                                className="size-10 object-contain transition-all duration-300 hover:scale-150"
                                ...
                                <TableCell>
                                    {hasPermission('banner update') ? (
                                        <MyUpdateStatusButton
                                            id={item.id}
                                            pathName="/admin/banner_positions"
