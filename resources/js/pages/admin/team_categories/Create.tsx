...
export default function Create({
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            if (editData?.id) {
                post('/admin/team_categories/' + editData?.id + '/update', {
                    preserveScroll: true,
                    onSuccess: (page) => {
                        setFiles(null);
                        setFilesBanner(null);
                            ...
                            {editData?.image && (
                                <div className="mt-4 p-1">
                                    ...
                                    <div className="grid w-full grid-cols-2 gap-2 rounded-md lg:grid-cols-3">
                                        ...
                                        >
                                            <img
                                                src={'/assets/images/team_categories/thumb/' + editData?.image}
                                                alt={editData?.image}
                            ...
                            {editData?.banner && (
                                <div className="mt-4 p-1">
                                    ...
                                    <div className="grid w-full grid-cols-2 gap-2 rounded-md lg:grid-cols-3">
                                        ...
                                        >
                                            <img
                                                src={'/assets/images/team_categories/thumb/' + editData?.banner}
                                                alt={editData?.banner}
                                                className="h-full w-full object-contain"
                                            />
                                        </span>
