...
export default function Create({
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            if (editData?.id) {
                post('/admin/phone_companies/' + editData.id + '/update', {
                    preserveScroll: true,
                    onSuccess: (page) => {
                        setFiles(null);
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormMessage>{errors.company && <div>{errors.company}</div>}</FormMessage>
                                </FormItem>
                            )}
                        />
                    </div>
                            ...
                            {editData?.image && (
                                <div className="mt-4 p-1">
                                    ...
                                    <div className="grid w-full grid-cols-2 gap-2 rounded-md lg:grid-cols-3">
                                        ...
                                        >
                                            <img
                                                src={'/assets/images/phone_companies/thumb/' + editData?.image}
                                                alt={editData?.image}
