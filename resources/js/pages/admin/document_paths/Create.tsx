...
export default function Create({
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            if (editData?.id) {
                post('/admin/document_paths/' + editData.id + '/update', {
                    preserveScroll: true,
                    onSuccess: (page) => {
                        setFiles(null);
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input autoFocus placeholder="Name" type="text" {...field} />
                                    </FormControl>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="ex: /Toyota" type="text" {...field} />
                                    </FormControl>
                                    <FormMessage>{errors.path && <div>{errors.path}</div>}</FormMessage>
                                </FormItem>
                            )}
                        />
                    </div>
                            ...
                            {editData?.image && (
                                <div className="mt-4 p-1">
                                    ...
                                    <div className="grid w-full grid-cols-2 gap-2 rounded-md lg:grid-cols-3">
                                        ...
                                        >
                                            <img
                                                src={'/assets/images/document_paths/thumb/' + editData?.image}
                                                alt={editData?.image}
