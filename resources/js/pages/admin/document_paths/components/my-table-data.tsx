    ...
    return (
        <>
            <ScrollArea className="w-full rounded-md border">
                <MyImageGallery
                    imagePath="/assets/images/document_paths/"
                                ...
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell>
                                        <span className="flex h-full items-center justify-start">
                                            ...
                                            {hasPermission('document delete') && <DeleteButton deletePath="/admin/document_paths/" id={item.id} />}
                                            {hasPermission('document update') && <EditButton item={item} />}
                                        </span>
                                    </TableCell>
                                    <TableCell>
                                        {item.image ? (
                                            ...
                                            >
                                                <img
                                                    src={`/assets/images/document_paths/thumb/` + item.image}
                                                    width={100}
                                                    height={100}
                                                    alt=""
