...
const formSchema = z.object({
    ...
    image: z.string().optional(), // consider using z.string().url() if validating image URL
...
export default function Create({
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            if (editData?.id) {
                post('/admin/video_play_lists/' + editData.id + '/update', {
                    preserveScroll: true,
                    onSuccess: (page) => {
                        setFiles(null);
                            ...
                            {editData?.image && (
                                <div className="mt-4 p-1">
                                    ...
                                    <div className="grid w-full grid-cols-2 gap-2 rounded-md lg:grid-cols-3">
                                        ...
                                        >
                                            <img
                                                src={'/assets/images/video_play_lists/thumb/' + editData?.image}
                                                alt={editData?.image}
