    ...
    return (
        <>
            <ScrollArea className="w-full rounded-md border">
                <MyImageGallery
                    imagePath="/assets/images/item_body_types/"
                                ...
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell>
                                        <span className="flex h-full items-center justify-start">
                                            ...
                                            {hasPermission('item delete') && <DeleteButton deletePath="/admin/item_body_types/" id={item.id} />}
                                    ...
                                    <TableCell>
                                        {hasPermission('item update') ? (
                                            <MyUpdateStatusButton
                                                id={item.id}
                                                pathName="/admin/item_body_types"
