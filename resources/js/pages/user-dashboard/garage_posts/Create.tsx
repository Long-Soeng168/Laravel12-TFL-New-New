...
import { CalendarIcon, ChevronsUpDown, CloudUpload, Loader } from 'lucide-react';
...
export default function Create() {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        try {
            ...
            if (editData?.id) {
                post(`/user-garage_posts/${editData?.id}/update`, {
                    preserveScroll: true,
                    onSuccess: (page) => {
                        setFiles(null);
                                    ...
                                    <>
                                        ...
                                        >
                                            ...
                                            <span className="absolute top-1 right-1 group-hover:opacity-100 lg:opacity-0">
                                                <DeleteButton deletePath="/user-garage_posts/images/" id={imageObject.id} />
                                            </span>
                                        </span>
                                    </>
